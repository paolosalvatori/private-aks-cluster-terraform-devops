...
variable dns_zone_name {
  description = "(Required) Specifies the name of the Private DNS Zone to link jumpbox's virtual network to"
  type        = string
}
...
variable  kube_config_raw {
  description = "(Required) Specifies the raw kubeconfig"
  type        = string
}
...
variable "custom_script_file_uri" {
